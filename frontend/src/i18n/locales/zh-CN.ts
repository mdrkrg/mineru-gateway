...
export const zhCN: Dict = {
  ...
  'errors.network': '网络连接失败，请检查网络后重试',
  'errors.validation': '响应数据格式异常，请稍后重试',
  'errors.unexpectedStatus': '未知状态码 {{status}}',
  'errors.unexpected': '发生未知错误，请重试',
  'errors.unknown': '未知错误',

  // Backend `detail` -> message (utils/api-error.ts)
  'errors.detail.invalidCredentials': '邮箱或密码错误',
  'errors.detail.invalidRefreshToken': '登录状态已失效，请重新登录',
  'errors.detail.notAuthenticated': '登录状态已失效，请重新登录',
  'errors.detail.apiKeyRequired': '请先在 API Keys 页面设置 API Key',
  'errors.detail.invalidApiKey': 'API Key 无效或已被吊销，请在 API Keys 页面重新设置',
  'errors.detail.invalidAdminToken': '管理令牌无效，请重新输入',
  'errors.detail.emailNotVerified': '邮箱尚未验证，请先完成邮箱验证',
  'errors.detail.passwordRules': '密码不符合要求（至少 8 位）',
  'errors.detail.emailAlreadyRegistered': '该邮箱已注册，请直接登录',
  'errors.detail.registrationClosed': '当前已关闭注册',
  'errors.detail.keyNotFound': 'API Key 不存在或已被吊销',
  'errors.detail.taskNotFound': '任务不存在或已被清理',

  // HTTP status fallbacks (utils/api-error.ts)
  'errors.status.400': '请求参数有误，请检查后重试',
  'errors.status.401': '登录状态已失效，请重新登录',
  'errors.status.403': '没有权限执行该操作',
  'errors.status.404': '请求的资源不存在或已被清理',
  'errors.status.409': '操作与当前状态冲突，请刷新后重试',
  'errors.status.413': '上传内容超过大小上限',
  'errors.status.422': '提交的内容未通过校验，请检查后重试',
  'errors.status.429': '操作过于频繁，请稍后重试',
  'errors.status.500': '服务器内部错误，请稍后重试',
  'errors.status.502': '上游服务暂时不可用，请稍后重试',
  'errors.status.503': '服务繁忙，请稍后重试',
  'errors.status.504': '上游服务响应超时，请稍后重试',
  'errors.uploadLimitWithSize': '上传内容超过大小上限（{{limit}}）',
  'errors.requestFailed': '请求失败（HTTP {{status}}）',

  // Client-side upload pre-check (utils/upload.ts)
  'errors.uploadOversizedFiles': '以下文件超过单次上传上限 {{limit}}：{{names}}',
  'errors.uploadOversizedTotal': '所选文件共 {{size}}，超过单次上传上限 {{limit}}。',
  ...
  'mineruLang.label.chServer': '中文服务端版',
  ...
  'mineruLang.coverage.eastSlavic': '俄语、白俄罗斯语、乌克兰语、英文',
  'mineruLang.coverage.cyrillic': '俄语、白俄罗斯语、乌克兰语、塞尔维亚语、保加利亚语、蒙古语、哈萨克语、吉尔吉斯语、塔吉克语等 30+ 种使用西里尔字母的语言、英文',
  'mineruLang.coverage.devanagari': '印地语、马拉地语、尼泊尔语、比哈里语、迈蒂利语、梵语等 14 种使用天城文的语言、英文',

  // Upload page
  'upload.fileSection': '文件',
  'upload.filePicker': '点击选择文件，或将文件拖拽到此处（可多选）',
  ...
  'tasks.confirmCancelTitle': '取消任务',
  'tasks.confirmBatchCancelTitle': '批量取消任务',
  'tasks.confirmBatchCancelText': '批量取消',
  'tasks.autoRefreshHint': '进行中的任务会自动刷新',
  'tasks.cancelledToast': '任务已取消',
  'tasks.batchCancelToast': '已取消 {{count}} 个任务',
  ...
  'taskDetail.partialResultHint': '任务失败，可尝试下载部分结果。',

  // Result download page
  'download.description': '这里列出所有可下载结果的任务（含失败任务的部分结果），可单个下载或勾选后打包下载 ZIP。',
  'download.pack': '打包下载（{{count}}）',
  'download.empty': '还没有可下载结果的任务。',
  'download.thTaskId': '任务 ID',
  'download.thFiles': '文件',
  'download.thStatus': '状态',
  ...
  'apiKeys.set': '设置',
  'apiKeys.createdToast': 'API Key 创建成功',
  ...
  'adminKeys.issuedToast': 'API Key 签发成功',
